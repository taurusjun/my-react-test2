...
import { TextField, Select, MenuItem, Button, Box, FormControl, InputLabel, CircularProgress } from '@mui/material';
...
const EditExam = () => {
    ...
    return (
        <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ maxWidth: 400, mt: 2 }}>
            <Controller
                name="name"
                control={control}
                defaultValue=""

      ...
      section.questions.forEach((question) => {
        question.questionDetails.forEach((detail) => {
          ...
          if (
            ...
            if (correctAnswer && typeof correctAnswer === 'object' && correctAnswer.content) {
              correctAnswerArray = Array.isArray(correctAnswer.content) ? correctAnswer.content : [correctAnswer.content];
            } else if (Array.isArray(correctAnswer)) {
              correctAnswerArray = correctAnswer;
            }
            
            if (Array.isArray(studentAnswer) && Array.isArray(correctAnswerArray)) {

...
const QuestionEdit = () => {
  ...
  const checkBeforeSubmit = () => {
    let newErrors = {
      ...
      category: category === "",
      kn: kn === "",
      school: gradInfo.school === "",
      grad: gradInfo.grad === "",
      digest: digest.trim() === "",
      questionDetail: {
        questionContent: questionDetail.questionContent.value.trim() === "",
        rows: questionDetail.rows.map((row) => row.value.trim() === ""),
        answer: !questionDetail.answer || questionDetail.answer.length === 0,
        rate: questionDetail.rate === 0,
      },
    };
        ...
        <Box component="form" noValidate autoComplete="off">
          <Box sx={{ display: "flex", gap: 1, ml: 2, mr: 2, mt: 2, mb: 2 }}>
            ...
            <MultiLevelSelect
              ...
              initialSchoolLevel={gradInfo.school}
              initialGrade={gradInfo.grad}
